    ...
    Dropzone.options.avatarDropzone = {
        ...
        init: function() {
            ...
            this.on("success", function(file, res) {
                ...
                $('#cat_selected_image, .user-avatar-nav').attr('src', '/images/products/categories/uploads/images/catImage/catImage.jpg?' + new Date().getTime());
            });
