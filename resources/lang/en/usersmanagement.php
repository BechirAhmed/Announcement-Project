...
return [
    ...
    'buttons' => [
        ...
        'delete'        => '<i class="mdi mdi-delete-empty" aria-hidden="true"></i>',
        'show'          => '<i class="mdi mdi-eye" aria-hidden="true"></i>',
        'edit'          => '<i class="mdi mdi-account-edit" aria-hidden="true"></i>',
    ...
    'messages' => [
        ...
        'fNameRequired'          => 'Full Name is required',
        'uTypeRequired'          => 'User Type is required',
