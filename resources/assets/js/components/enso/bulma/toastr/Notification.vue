...
import { faComment, faInfoCircle, faCheckCircle, faExclamationCircle, faTimesCircle, faSearch, faSync, faAngleDown }
    from '@fortawesome/fontawesome-free-solid/shakable.es';

fontawesome.library.add([
    faComment, faInfoCircle, faCheckCircle, faExclamationCircle, faTimesCircle,faSearch, faSync, faAngleDown,
]);
